...
### ip traffic only and exclude router
python3 scripts/ip_traffic_exclude_router.py ~/local_output/idle-dataset-dec-new/tcp_output/ ~/local_output/idle-dataset-dec-new/udp_output/ ~/locaal_output/idle-dataset-dec-new/ip_traffic_exclude_router
